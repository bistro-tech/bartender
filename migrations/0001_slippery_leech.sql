...
INSERT INTO `__new_blame`("id", "reason", "kind", "created_at", "updated_at", "expires_at", "blamee_id", "blamer_id") SELECT "id", "reason", "kind", "created_at", "updated_at", "expires_at", "blamee_id", "blamer_id" FROM `blame`;--> statement-breakpoint
DROP TABLE `blame`;--> statement-breakpoint
ALTER TABLE `__new_blame` RENAME TO `blame`;--> statement-breakpoint
